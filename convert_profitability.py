...
def content_to_pdf(input_file, output_file):
    ...
    <style>
        ...
        blockquote {{ border-left: 4px solid #e74c3c; background-color: #fadbd8; padding: 10px; margin: 15px 0; color: #c0392b; }}
        strong {{ color: #e74c3c; }} 
    </style>
    </head>
    <body>
...
if __name__ == "__main__":
    input_path = r"C:\Users\IV-UDP-DT-0122\.gemini\antigravity\brain\7e383187-f2e0-4052-97a2-e0b6d0b0a022\profitability_report.md"
    output_path = r"C:\Users\IV-UDP-DT-0122\.gemini\antigravity\brain\7e383187-f2e0-4052-97a2-e0b6d0b0a022\Profitability_Analysis_Report.pdf"
