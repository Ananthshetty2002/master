...
def content_to_pdf(input_file, output_file):
    ...
    # Add styling for a professional look (Same robust CSS as before)
    html_content = f"""
    <html>
    <head>
    <style>
...
if __name__ == "__main__":
    ...
    # Handling the complex filename
    input_filename = "Strategy Name FSN Analysis (Fast-Sl.md"
    output_filename = "Strategy Name FSN Analysis (Fast-Sl.pdf"
